...
2. In the terminal, navigate to the directory where you downloaded the 
   .zip file and execute the following command changing the argument
   <your-epic-server.zip> to the name of your downloaded file:

    #+begin_src shell
      unzip <your-epic-server.zip>
    #+end_src
...
** Running the Epic Server
  ...
  :CUSTOM_ID: run_epic
  :END:
After you finished unzipping, you can run it by executing the
...
2. Open a new terminal window and navigate to the directory where you
   downloaded the .zip file and execute the following command changing
   the argument <your-epic-wallet.zip> to the name of your downloaded
   file:

    #+begin_src shell
      unzip <your-epic-wallet.zip>
    #+end_src
...
should be something like this:
    ...
    #+begin_src shell
      File /home/[username]/.epic/main/epic-wallet.toml configured and created
...
You can also keep epic wallet's data and configuration files in the same
 directory. In the terminal, navigate to the directory in which
you want Epic to store its files and run:

    #+begin_src shell
      ./epic-wallet init --here
    #+end_src
